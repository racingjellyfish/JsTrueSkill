...
TwoTeamTrueSkillCalculator.prototype.updatePlayerRatings = function(gameInfo,
    ...
    var totalPlayers = selfTeam.getPlayers().length + otherTeam.getPlayers().length;
    ...
    var currentPlayer;
    var r;
    for (i = 0; i < selfTeam.getPlayers().length; i++) {
    ...
    for (i = 0; i < otherTeam.getPlayers().length; i++) {
...
TwoTeamTrueSkillCalculator.prototype.calculateMatchQuality = function(gameInfo,
    ...
    var team1 = teams[0];
    var team1Count = team1.getPlayers().length;

    var team2 = teams[1];
    var team2Count = team2.getPlayers().length;
    ...
    var currentPlayer;
    var r;
    for (i = 0; i < team1.getPlayers().length; i++) {
    ...
    for (i = 0; i < team2.getPlayers().length; i++) {
